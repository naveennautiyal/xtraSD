//
//  TableViewCellSelection.swift
//  xtraSD
//
//  Created by Optimus-66 on 12/18/15.
//  Copyright © 2015 iXTRA Technologies. All rights reserved.
//

import UIKit

class TableViewCellSelection:  UIView
{
    ...
    func drawRectChecked(rect: CGRect)
    {
        ...
        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalInRect: CGRectMake(1, 1, diameter, diameter))
